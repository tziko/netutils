...
public class TCPPacket extends IPPacket
{
	...
	public TCPPacket(byte[] thePacket)
	{
		...
		myTcpHdrLh = ((ByteUtils.getByteNetOrderTo_unit16(myIPPacket.myPacket, _tcpOffset + TCP_HDR_LEN_POS) >> 12) & 0x0f) * 4;
	...
	public int getSourcePort()
	{
		...
		{
			_isReadSrcPort = true;
			mySrcPort = ByteUtils.getByteNetOrderTo_unit16(myIPPacket.myPacket, _tcpOffset + TCP_SRC_PORT_POS);
		}
		return mySrcPort;
	}
	...
	public int getDestinationPort()
	{
		...
		{
			myDstPort = ByteUtils.getByteNetOrderTo_unit16(myIPPacket.myPacket, _tcpOffset + TCP_DST_PORT_POS);
			_isReadDstPort = true;
		}
		return myDstPort;
	}
	...
	public int getWindowSize()
	{
		...
		{
			myWindowSize = ByteUtils.getByteNetOrderTo_unit16(myIPPacket.myPacket, _tcpOffset + TCP_WINDOW_SIZE_POS);
			_isReadWindowSize = true;
		}
		return myWindowSize;
	}
	...
	public int getTCPChecksum()
	{
		...
		{
			myTcpChecksum = ByteUtils.getByteNetOrderTo_unit16(myIPPacket.myPacket, _tcpOffset + TCP_CHECKSUM_POS);
			_isReadTCPCheckSum = true;
		}
	...
	public int getUrgentPointer()
	{
		...
		{
			myUrgentPointer = ByteUtils.getByteNetOrderTo_unit16(myIPPacket.myPacket, _tcpOffset + TCP_URGENT_PTR_POS);
			_isReadUrgentPtr = true;
		}
	...
	public int getAllFlags()
	{
		...
		{
			myFlags = ByteUtils.getByteNetOrderTo_unit16(myIPPacket.myPacket, _tcpOffset + TCP_HDR_LEN_POS) & 0x3f;
			_isReadAllFlags = true;
		}
		return myFlags;
	}
