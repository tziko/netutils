...
public class IPv6Packet extends IPPacketBase
{
	...
	public int getIpPktTotalLength()
	{
		if (!_readTotalLength)
		{
			if (_isSniffedPkt)
			{
				myIPTotalLength = ByteUtils.getByteNetOrderTo_unit16(myPacket, myIPHdrOffset + IP_PAYLOAD_LENGTH_POS)+DEFAULT_IP_HDR_LENGTH;
	...
	public int getTrafficClass()
	{
		...
		{
			myTrafficClass = ByteUtils.getByteNetOrderTo_unit16(myPacket, myIPHdrOffset);
