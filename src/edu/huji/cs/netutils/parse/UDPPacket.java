...
public class UDPPacket extends IPPacket
{
	...
	public int getSourcePort()
	{
		...
		{
			mySrcPrt = ByteUtils.getByteNetOrderTo_unit16(myIPPacket.myPacket, _udpOffset);
			_isReadSrcPort = true;
		}
		return mySrcPrt;
	}
	...
	public int getDestinationPort()
	{
		...
		{
			_isReadDstPort = true;
			myDstPort = ByteUtils.getByteNetOrderTo_unit16(myIPPacket.myPacket, _udpOffset + UDP_DST_PORT_POS);
		}
		return myDstPort;
	}
	...
	public int getUDPLength()
	{
		...
		{
		   myUdpLn = ByteUtils.getByteNetOrderTo_unit16(myIPPacket.myPacket, _udpOffset + UDP_DATA_LENGTH_POS);
		}
		return myUdpLn;
	}
	...
	public int getUDPChecksum()
	{
		...
		{
		  myUdpChecksum = ByteUtils.getByteNetOrderTo_unit16(myIPPacket.myPacket, _udpOffset + UDP_CHECKSUM_POS);
		  _isReadUDPChkSum = true;
		}
	...
	protected int getUDPChksum()
	{
		...
		// run on the udp part
		for (int i = _udpOffset; i < myIPPacket.myPacket.length; i += 2)
		{
