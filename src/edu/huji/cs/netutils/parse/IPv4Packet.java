...
public class IPv4Packet extends IPPacketBase
{
	...
	public int getIpPktTotalLength()
	{
		if (!_readTotalLength)
		{
			if (_isSniffedPkt)
			{
				myIPTotalLength = ByteUtils.getByteNetOrderTo_unit16(myPacket, myIPHdrOffset + IP_LEN_POS);
	...
	public int getId()
	{
		...
		{
		    myIPid = ByteUtils.getByteNetOrderTo_unit16(myPacket, myIPHdrOffset + IP_ID_POS);
		    _isReadID = true;
		}
		return myIPid;
	}
	...
	public int getFragmentFlags()
	{
		...
		{
			_isReadFragFlags = true;
		    myFragmentFlags = ByteUtils.getByteNetOrderTo_unit16(myPacket, myIPHdrOffset + IP_FRAG_POS) >> 13;
		}
	...
	public int getFragmentOffset()
	{
		...
		{
			_isReadFragOffset = true;
		     myFragmentOffset = ByteUtils.getByteNetOrderTo_unit16(myPacket, myIPHdrOffset + IP_FRAG_POS) & 0x1fff;
		}
	...
	public int getIPChecksum()
	{
		...
		{
			_isReadChksum = true;
		     myChksum = ByteUtils.getByteNetOrderTo_unit16(myPacket, myIPHdrOffset + IP_CHKSUM_POS);
		}
		return myChksum;
	}
	...
	{
		return ByteUtils.getByteNetOrderTo_uint8(thePacket, EthernetFrame.ETHERNET_HEADER_LENGTH + IP_Proto_POS);
	}
	...
	{
		int b =  ByteUtils.getByteNetOrderTo_unit16(thePacket, ETHERNET_HEADER_LENGTH+IP_FRAG_POS);
		b>>=8;
